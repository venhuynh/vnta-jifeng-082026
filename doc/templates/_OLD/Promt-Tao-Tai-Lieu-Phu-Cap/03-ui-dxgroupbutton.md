# Prompt 03 — Mô tả UI — DxGroupButton và nhóm filter
...
<THU_MUC_TAI_LIEU_DICH>/03-ui-dxgroupbutton.md

Kiểm tra DxGroupButton, các biến thể group button và control có vai trò tương đương như badge/filter nhanh.
Nếu có, mô tả từng item, default selection, binding, multi/single select, handler, lọc client/server, enable/disable và reset sau reload.
Nếu không có, lập kết luận N/A có bằng chứng, rồi ghi component thay thế thực tế nếu tồn tại.

CẤU TRÚC BẮT BUỘC
1. Kết quả inventory/N/A.
2. Bảng item và binding.
3. State transition, filter semantics và accessibility keyboard.
4. Bằng chứng source.
```
