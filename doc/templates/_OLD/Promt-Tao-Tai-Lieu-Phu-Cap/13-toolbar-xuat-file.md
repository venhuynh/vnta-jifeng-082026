# Prompt 13 — Logic DxToolbar — Xuất file
...
<THU_MUC_TAI_LIEU_DICH>/13-toolbar-xuat-file.md

Phân tích action Xuất file và từng định dạng (Excel/PDF/khác): điều kiện enable, dropdown, tập dữ liệu xuất (visible/current page/all applied period), columns/format, export component/service, loading, dữ liệu rỗng, tên file, bảo mật dữ liệu và toast/error.
Phân biệt export client-side với API/server-side.

CẤU TRÚC BẮT BUỘC
1. Inventory định dạng/trigger.
2. Data scope và mapping dữ liệu.
3. Sequence xuất file.
4. Loading/error/security/performance/test.
5. Bằng chứng source.
```
