...
- Infrastructure root hiện tại: `src/Vnta.HRM2026/Vnta.Hrm.Infrastructure/PhuCap/PhuCapTrachNhiem`
- Application contracts liên quan: `src/Vnta.HRM2026/Vnta.Hrm.Application/PhuCap/PhuCapTrachNhiem` (`IPayrollResponsibilityAllowanceGradeConfigurationReadService`, `IPayrollResponsibilityAllowanceGradeConfigurationWriteService` và request/result/DTO).
- Schema/migration được phép thay đổi: Không; bảo toàn bảng/cột/index/constraint hiện có, transaction, concurrency, trạng thái sử dụng và audit.
