...
public partial class KhauTruKhacMonthlyWorkPopup
{
    ...
    [
        new("Công hành chính", FormatWorkday(AdministrativeWorkdays), VntaDevExpressIcons.WorkCalendar, ButtonRenderStyle.Primary, "other-deduction-monthly-work-summary-card summary-card-primary"),
        new("Công tính lương", FormatSalaryWorkday(CalculatedSalaryWorkdays), VntaDevExpressIcons.CalculatorCoins, ButtonRenderStyle.Success, "other-deduction-monthly-work-summary-card summary-card-success"),
        new("Tăng ca 1.5", FormatHours(OvertimeMinutes15), VntaDevExpressIcons.Attendance, ButtonRenderStyle.Info, "other-deduction-monthly-work-summary-card summary-card-info"),
        new("Tăng ca 2.0", FormatHours(OvertimeMinutes20), VntaDevExpressIcons.Attendance, ButtonRenderStyle.Warning, "other-deduction-monthly-work-summary-card summary-card-warning"),
        new("Tăng ca 3.0", FormatHours(OvertimeMinutes30), VntaDevExpressIcons.Attendance, ButtonRenderStyle.Danger, "other-deduction-monthly-work-summary-card summary-card-danger"),
        new("Tổng giờ tăng ca", FormatHours(TotalOvertimeMinutes), VntaDevExpressIcons.SummaryTotalEmployees, ButtonRenderStyle.Primary, "other-deduction-monthly-work-summary-card summary-card-total"),
        new("Đi trễ/về sớm", LateEarlyMinutesTotal.ToString("N0", VietnameseCulture), VntaDevExpressIcons.SummaryLate, ButtonRenderStyle.Warning, "other-deduction-monthly-work-summary-card summary-card-warning")
    ];
    ...
    {
        AllSummaryKey => "other-deduction-monthly-work-summary-button summary-all",
        "Ngày nghỉ" or "Ngày lễ" => "other-deduction-monthly-work-summary-button summary-special-day",
        _ => "other-deduction-monthly-work-summary-button summary-regular-day"
    };

    private static string GetStatusSummaryCssClass(string key) => key switch
    {
        AllSummaryKey => "other-deduction-monthly-work-summary-button summary-all",
        "FULL_WORK" or "VR" => "other-deduction-monthly-work-summary-button summary-success",
        "LATE_EARLY" or "MISSING_LOG" or "TS" => "other-deduction-monthly-work-summary-button summary-warning",
        "ABNORMAL" or "KP" => "other-deduction-monthly-work-summary-button summary-danger",
        _ => "other-deduction-monthly-work-summary-button summary-neutral"
    };
