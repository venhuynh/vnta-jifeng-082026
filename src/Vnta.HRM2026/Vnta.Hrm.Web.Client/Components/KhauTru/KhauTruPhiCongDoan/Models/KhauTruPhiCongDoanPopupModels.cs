...
public sealed class KhauTruPhiCongDoanEditModel
{
    ...
    [Range(typeof(decimal), "0", "9999999999999999.99", ErrorMessage = "Số tiền phí công đoàn phải nằm trong phạm vi cho phép.")]
    public decimal DeductionAmount { get; set; }

    public bool IsLocked { get; set; }

    public DateTime OriginalVersionAtUtc { get; set; }
}
