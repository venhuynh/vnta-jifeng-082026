...
/// <summary>Hộp chọn phạm vi khóa hoặc mở khóa dữ liệu Thuế TNCN.</summary>
public partial class KhauTruThueTNCNLockActionPopup
{
    ...
    {
        var cssClasses = new List<string> { "personal-income-tax-lock-action-option" };
