...
/// <summary>Đại diện kiểu <c>PhuCapChuyenCanLockActionPopup</c> phục vụ màn hình phụ cấp chuyên cần.</summary>
public partial class PhuCapChuyenCanLockActionPopup
{
    ...
    {
        var cssClasses = new List<string> { "attendance-allowance-lock-action-option" };
