...
/// <summary>Popup chọn phạm vi trước khi khóa hoặc mở khóa phụ cấp độc hại.</summary>
public partial class PhuCapDocHaiLockActionPopup
{
    ...
    {
        var cssClasses = new List<string> { "hazard-lock-action-option" };
