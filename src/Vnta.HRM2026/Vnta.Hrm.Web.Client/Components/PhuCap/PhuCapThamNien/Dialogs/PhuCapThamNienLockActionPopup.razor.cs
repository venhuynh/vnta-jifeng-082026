...
/// <summary>Đại diện kiểu <c>PhuCapThamNienLockActionPopup</c> phục vụ giao diện phụ cấp thâm niên.</summary>
public partial class PhuCapThamNienLockActionPopup
{
    ...
    {
        var cssClasses = new List<string> { "seniority-lock-action-option" };
