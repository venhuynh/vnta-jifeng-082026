...
public static class VntaCrypto
{
    ...
    public static string GenerateActivationCode(string serialNumber)
    {
    ...
    public static bool ValidateActivationCode(string serialNumber, string activationCode)
    {
        ...
        var expected = NormalizeActivationCode(GenerateActivationCode(serialNumber));
